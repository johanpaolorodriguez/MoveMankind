...
export const SIGN_UP_ABOUT = "/signup/about";
export const SIGN_UP_INTERESTS = "/signup/interests";
export const SIGN_UP_TALENT = "/signup/talent";
export const SIGN_UP_CONTRIBUTIONS = "/signup/contributions";
