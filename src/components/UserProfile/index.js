      ...
      {user ? (
        <div>
          <div className="space-y-8">
            ...
            <p className="">
              Buck drives strategic partnerships and corporate development at
              Miso. As a technologist and early-stage venture investor, he has a
              track record of building successful businesses at the leading edge
              of technology in transformative, high growth markets. He has held
              roles at Wavemaker Partners and Wavemaker Labs, and founded VC
              firm Canyon Creek Capital.
            </p>
          </div>
          {startups.length !== 0 ? (
            <div>
              <h1 className="mt-16 text-3xl font-bold text-primary">
                Ventures
              </h1>
